...
namespace Gherghelas_Theodora_Lab2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Gherghelas_Theodora_Lab2.Data.Gherghelas_Theodora_Lab2Context context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(Input.Email, "Confirm yout email",

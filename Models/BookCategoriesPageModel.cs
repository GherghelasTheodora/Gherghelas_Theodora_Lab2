...
namespace Gherghelas_Theodora_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Gherghelas_Theodora_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Gherghelas_Theodora_Lab2Context context, string[] selectedCategories,
            Book bookToUpdate)
        {
